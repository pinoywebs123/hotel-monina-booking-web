        ...
        <div id="page-wrapper">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <a href="{{route('admin_new_customer_twin')}}" class="btn btn-default">New Guest</a>
              <table class="table">
                  <thead>
                    <tr>
                      <th>Name</th>
                  ...
                  @foreach($users as $user)
                    <tr class="{{$user->status_id == 0 ? 'alert alert-danger': ''}}">
                      ...
                      <td>{{$user->email}}</td>
                      <td>
                        <form action="{{route('admin_user_lock', ['id'=> $user->id])}}" method="get" id="formDel{{$user->id}}">
 ...
 <script type="text/javascript">
    $(document).ready(function(){
        $(".delMe").click(function(){
            ...
            swal({
              title: "Are You Sure??",
              text: "Once Account Lock, Customer can no longer access his/her account" + id_to_del,
              icon: "warning",
              buttons: true,
              dangerMode: true,
            })
