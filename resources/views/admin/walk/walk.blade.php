        ...
        <div id="page-wrapper">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="text-center">Walk-In Customers</h3>
            </div>
            <div class="panel-body">
              @if(Session::has('cancel'))
               ...
               @if(Session::has('paid'))
                  ...
                  @foreach($cats as $cat)
                    <div class="col-md-4">
                      <a href="{{route('admin_walkin_cat', ['id'=> $cat->id,'cat'=> $cat->category_name])}}" >
                      <div class="panel panel-primary">
                        <div class="panel-heading">
                         <i class="glyphicon glyphicon-home">Occupants: {{$cat->person}} | Price: {{$cat->price}}</i>
                        </div>
                        <div class="panel-body">

                          <h2 class="text-center">{{$cat->category_name}}</h2>
                        </div>
                      </div>
                    </a>
                    </div>
